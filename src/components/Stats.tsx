...
const Stats = () => {
  return (
    <div className="md:grid-col-2 grid gap-4 lg:grid-cols-4">
      <div className="flex flex-col space-y-1.5 rounded-xl border border-gray-100 bg-gray-50 px-6 py-5">
      ...
      <div className="flex flex-col space-y-1.5 truncate rounded-xl border border-gray-100 bg-gray-50 px-6 py-5">

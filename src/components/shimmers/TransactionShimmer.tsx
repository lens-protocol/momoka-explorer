  ...
  return (
    <Card className="mt-6">
      <div className="flex flex-wrap items-center justify-between space-y-3 px-4 sm:px-0">
        ...
        <div className="h-8 w-40 animate-pulse rounded-xl bg-[#F1F8F3] dark:bg-[#2C2B35]" />
      </div>
      <div className="mt-6 border-t border-gray-200 dark:border-gray-900">
        {txns.map((_, i) => (
          <Meta
            key={i}
            title={<div className="h-4 w-28 animate-pulse rounded-xl bg-[#F1F8F3] dark:bg-[#2C2B35]" />}
            value={
              <div
                className="h-4 animate-pulse rounded-xl bg-[#F1F8F3] dark:bg-[#2C2B35]"
